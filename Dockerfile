...
# Create centreon's temporary directory
# RUN mkdir /usr/share/centreon/www/tmp/ && chown centreon:apache -R /usr/share/centreon/www/ && chmod a+w /usr/share/centreon/www/tmp
